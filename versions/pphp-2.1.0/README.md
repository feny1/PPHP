...
[![Download PPHP v2.1.0](https://img.shields.io/badge/Download-PPHP%20v2.1.0-success?style=for-the-badge&logo=github)](https://github.com/feny1/PPHP/raw/main/versions/pphp-2.1.0.zip)
[![Download PPHP v2.0.0](https://img.shields.io/badge/Download-PPHP%20v2.0.0-success?style=for-the-badge&logo=github)](https://github.com/feny1/PPHP/raw/main/versions/pphp-2.0.0.zip)
[![Download PPHP v1.0.0](https://img.shields.io/badge/Download-PPHP%20v1.0.0-inactive?style=for-the-badge&logo=github)](https://github.com/feny1/PPHP/raw/main/versions/pphp-1.0.0.zip)
...
### 🎯 Force Template Type (New in v2.1.0)

You can override the template type using the `?type=` URL parameter:

```
# Use profile template regardless of TYPE in .pphp file
http://localhost/mypage?type=profile

# Use dashboard template
http://localhost/contact?type=dashboard

# Use custom template
http://localhost/data?type=custom
```

This is useful for:
- 📱 Rendering the same content with different layouts
- 🎨 A/B testing different designs
- 🔧 Quick template switching during development
...
Access with different templates:
- `?type=profile` - Shows as profile page
- `?type=dashboard` - Shows as dashboard
- Default TYPE is used if no `?type=` parameter
...
### v2.1.0 (Latest - November 2025)
- ✨ **New Feature**: Force template type with `?type=` URL parameter
- 🎨 Override template rendering on-the-fly
- 🔧 Perfect for A/B testing and multi-view layouts

### v2.0.0
- 📦 Added `<<OBJECT>>` syntax for associative arrays
- 📚 Added `<<OBJECTS>>` syntax for array of objects
- 🎨 Enhanced template system

### v1.0.0
- 🚀 Initial release
- 📋 `<<LIST>>` syntax for arrays
